...
use aqc_file_engine_core::{
    ConfigScalar, Finding, ResolvedRequirement, Severity, parse_version_tuple,
};
...
pub(crate) fn attribution<Merged, Assertion>(
    resolved: &ResolvedRequirement<Merged, Assertion>,
) -> Vec<aqc_file_engine_core::Provenance> {
    resolved
        .collected
        .iter()
...
pub(crate) fn push_mismatch(
    ...
    expected: String,
    message: String,
    attribution: &[aqc_file_engine_core::Provenance],
) {
